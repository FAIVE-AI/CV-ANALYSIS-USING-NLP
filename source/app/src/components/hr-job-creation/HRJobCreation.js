    ...
    return (
      <div>
        <div id="hr-form-body-container">
          ...
          <div className="job-field-container">
            <label className="hr-form-label" htmlFor="job-post-location">
              Location :{" "}
            </label>
            <select
              className="job-posting-input"
          ...
          <div className="job-field-container">
            <label className="hr-form-label" htmlFor="job-post-last-date">
              Last Date To Apply :{" "}
            </label>
            <input
              editable
          ...
          <div className="job-field-container">
            <label className="hr-form-label" htmlFor="job-post-Salary">
              Salary :{" "}
            </label>
            <input
              editable
          ...
          <div className="job-field-container">
            <label className="hr-form-label" htmlFor="job-post-description">
              Job Description :{" "}
            </label>
            <textarea
              editable
          ...
          <div className="job-field-container">
            <label className="hr-form-label" id="job-post-qualifications">
              Job Qualifications :{" "}
            </label>
            <textarea
              editable
          ...
          <NavLink id="post-job-navlink" to={"/hr-view-jobs"}>
